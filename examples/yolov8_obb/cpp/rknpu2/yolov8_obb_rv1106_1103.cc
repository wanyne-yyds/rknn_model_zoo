...
int init_yolov8_obb_model(const char *model_path, rknn_app_context_t *app_ctx)
{
    ...
    std::cout << "RKNN Init Time taken: " << duration << " milliseconds" << std::endl;
    ...
    printf("the number of output tensors: %d\n", io_num.n_output);
...
int inference_yolov8_obb_model(rknn_app_context_t *app_ctx, image_buffer_t *img, object_detect_result_list *od_results)
{
    ...
    printf("convert_image_with_letterbox time: %ld ms\n", (tv2.tv_sec-tv1.tv_sec)*1000 + (tv2.tv_usec-tv1.tv_usec)/1000);
    ...
    gettimeofday(&tv2, NULL);
    printf("post_process time: %ld ms\n", (tv2.tv_sec-tv1.tv_sec)*1000 + (tv2.tv_usec-tv1.tv_usec)/1000);
